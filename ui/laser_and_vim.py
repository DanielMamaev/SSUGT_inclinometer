...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.label_status_esp_laser_icon_2.sizePolicy().hasHeightForWidth())
        self.label_status_esp_laser_icon_2.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.label_status_esp_laser_connect_2.sizePolicy().hasHeightForWidth())
        self.label_status_esp_laser_connect_2.setSizePolicy(sizePolicy1)
        ...
        sizePolicy2.setHeightForWidth(self.pushButton_start_stream.sizePolicy().hasHeightForWidth())
        self.pushButton_start_stream.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout_4.addWidget(self.checkBox_start_position, 3, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.checkBox_view_points, 9, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.spinBox_points, 8, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.checkBox_segmentaion_show, 11, 0, 1, 2)

        self.checkBox_rectangle_show = QCheckBox(self.frame_4)
        self.checkBox_rectangle_show.setObjectName(u"checkBox_rectangle_show")

        self.gridLayout_4.addWidget(self.checkBox_rectangle_show, 10, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.checkBox_enable_record, 6, 0, 1, 2)
        ...
        self.gridLayout_4.addWidget(self.pushButton_start_position, 4, 0, 1, 2)
